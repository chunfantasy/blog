...
let RTCPeerConnection = require('webrtc-adapter');
let RTCSessionDescription = require('webrtc-adapter');
...
{% highlight javascript %}
navigator.getUserMedia({video: true, audio: true}, function(success){}, function(error){});
{% endhighlight %}
